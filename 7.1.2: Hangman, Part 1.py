...
while True:                                 # now we run the program
    ...
    if restart == "yes" or "Yes":        # if they choose yes, the game restarts
        continue
    elif restart == "no" or "No":        # if they choose no, the program ends
        break
    else:
        print("Input not recognized!! Closing...")
        break                   # if the input is not recognized it prints a warning and the program ends

# In conclusion, the program could probably be made more efficiently but the coding was hurryed in order to be
# able to focus on the R&D project for innovation day that I will soon upload
